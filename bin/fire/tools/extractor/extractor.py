...
def usage(commandline):
  ...
  print "            default:", os.path.dirname(sys.argv[0]) + "../../bin/x86/"
  print "  -q (day|week)"
...
class Extractor:
  ...
  def __init__(self):
    ...
    self.firedir = self.progdir + "/../../bin/x86/"
  ...
  def extractFeature(self, feature):
    ...
    if self.queue == "day":
      queueline = "qsubmit -n " + self.name + "." + feature + " -m 1.0 -t 23:55:00 -bash -x86 "
      print "job", queueline + commandline
      os.system(queueline + commandline)
    elif self.queue == "week": 
      queueline = "qsubmit -n " + self.name + "." + feature + " -m 1.0 -t 167:55:00 -bash -x86 "
      print "job", queueline + commandline
      os.system(queueline + commandline)
    else:
